...
$servername = "localhost";
    ...
    if(count($_POST)>0) {
        $sql = "UPDATE temp_quotations SET farmer_id='".$_POST['farmerId']."', FarmerName='".$_POST['farmerName']."' , rice_type='".$_POST['paddyType']."' , amount='".$_POST['harvestAmount']."' WHERE temp_id='".$_GET['updateid']."'";
        $result = mysqli_query($conn,$sql);
        header("location: ./farmer-add-harvest.php");
    }

    $result2 = mysqli_query($conn, "SELECT * FROM temp_quotations WHERE temp_id='".$_GET['updateid']."'");
